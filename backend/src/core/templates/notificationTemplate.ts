function extractStringBetweenPercentSigns(inputString: string): {
  extractedString: string;
  modifiedString: string;
} {
  const startIndex: number = inputString.indexOf('%');
  const endIndex: number = inputString.lastIndexOf('%');

  if (startIndex === -1 || endIndex === -1 || startIndex >= endIndex) {
    return { extractedString: '', modifiedString: inputString };
  }

  const extractedString: string = inputString.substring(
    startIndex + 1,
    endIndex,
  );

  const modifiedString: string =
    inputString.substring(0, startIndex) + inputString.substring(endIndex + 1);

  return { extractedString, modifiedString };
}

export const getNotificationTemplate = (data) => {
  const { extractedString, modifiedString } = extractStringBetweenPercentSigns(
    data.message,
  );
  const lightTheme = {
...
<head>
    ...
    <title>Notification</title><!--[if (mso 16)]>
    <style type="text/css">
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            <tr>
                                                <td class="es-m-p0r es-m-p20b" valign="top" align="center" style="padding:0;Margin:0;width:600px">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;position:relative"><img class="adapt-img" src="https://eifdhct.stripocdn.email/content/guids/bannerImgGuid/images/image17133704912165323.png" alt title width="600" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" height="226"></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding-bottom:5px;padding-top:10px;padding-left:40px;padding-right:40px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#FFFFFF;font-size:16px">Hi ${data.name},</p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#FFFFFF;font-size:16px">&nbsp; &nbsp;You have a new notification from Templeton:</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" style="padding:10px;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:30px;color:#FFFFFF;font-size:20px">&nbsp;&nbsp; ${modifiedString}</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;padding-bottom:10px"><!--[if mso]><a href="https://digiwaysite.tech/" target="_blank" hidden>
                                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://digiwaysite.tech/"
                                                                             style="height:39px; v-text-anchor:middle; width:136px" arcsize="0%" stroke="f"  fillcolor="#1d77ff">
                                                                    <w:anchorlock></w:anchorlock>
                                                                    <center style='color:#f6f6f6; font-family:lato, "helvetica neue", helvetica, arial, sans-serif; font-size:14px; font-weight:400; line-height:14px;  mso-text-raise:1px'>Check it</center>
                                                                </v:roundrect></a>
                                                                <![endif]--><!--[if !mso]><!-- --><span class="msohide es-button-border" style="border-style:solid;border-color:#2CB543;background:#1d77ff;border-width:0px;display:inline-block;border-radius:0px;width:auto;mso-hide:all"><a href="https://digiwaysite.tech/" class="es-button es-button-1713358483246" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#f6f6f6;font-size:16px;display:inline-block;background:#1d77ff;border-radius:0px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-weight:normal;font-style:normal;line-height:19px;width:auto;text-align:center;padding:10px 30px;mso-padding-alt:0;mso-border-alt:10px solid #1d77ff">Check it</a></span><!--<![endif]--></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>
